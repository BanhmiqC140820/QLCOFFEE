...
<body>
    ...
    <div class="container mt-4">
  		<form action="QlloaiController" method="post">
            <div class="mb-3">
               <input type="text" class="form-control" name="txtmaloai" placeholder="Mã Loại" value="${ml}">
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" name="txttenloai" placeholder="Tên lọai" value="${tenloai}">
            </div>
		    ...
		    <c:forEach var="xn" items="${dsloai}">
			     <tbody>
			      <tr>
			    	<td>${xn.getMaLoai()}</td>
			    	<td>${xn.getTenLoai()}</td>
			    	<td><a class="btn" href="QlloaiController?ml=${xn.getMaLoai()}&tenloai=${xn.getTenLoai()}&tab=chon">SELECT</a> </td>
			    	<td><a class="btn" href="QlloaiController?ml=${xn.getMaLoai()}&tab=xoa">DELETE</a></td>
			      </tr>
			     </tbody>
		     </c:forEach>
		  </table>
